...
const StylePointDetail = ({ id }: StylePoint): StylePointDetails | null => {
  switch (id) {
    case 1:
      return {
        stylepoint: '유니크',
        styledetail: '변화에 민감하고<br/>개성을 추구하는',
        details: [
    ...
    case 2:
      return {
        stylepoint: '스트릿',
        styledetail: '서브컬쳐와<br/>힙한 무드가 공존하는',
        details: [
    ...
    case 3:
      return {
        stylepoint: '모던',
        styledetail:
          '장식적인 것 없이 깔끔하고 심플하며<br/>직선적인 실루엣을 추구하는',
        details: [
    ...
    case 4:
      return {
        stylepoint: '노멀',
        styledetail: '무난하면서도<br/>센스 포인트가 가득한',
        details: [
    ...
    case 5:
      return {
        stylepoint: '러블리',
        styledetail: '사랑스러움과<br/>로맨틱이 넘쳐나는',
        details: [
    ...
    case 6:
      return {
        stylepoint: '레트로',
        styledetail: 'Y2K감성을<br/>재해석한 빈티지한',
        details: [
    ...
    case 7:
      return {
        stylepoint: '글램',
        styledetail: '섹시함이 강조되는<br/>화려하고 여성스러운',
        details: [
    ...
    case 8:
      return {
        stylepoint: '액티브',
        styledetail: '일상의 경계를<br/>허무는 스포티한',
        details: [
